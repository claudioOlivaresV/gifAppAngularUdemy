// To parse this data:
//
//   import { Convert, SeachGifsReponse } from "./file";
//
//   const seachGifsReponse = Convert.toSeachGifsReponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SeachGifsReponse {
    data:       Gif[];
...
export class Convert {
    public static toSeachGifsReponse(json: string): SeachGifsReponse {
        return cast(JSON.parse(json), r("SeachGifsReponse"));
    }

    public static seachGifsReponseToJson(value: SeachGifsReponse): string {
        return JSON.stringify(uncast(value, r("SeachGifsReponse")), null, 2);
    }
}
